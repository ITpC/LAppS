...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lapps.avx.nostats.notls: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lapps.avx.nostats.notls ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -flto -lwolfssl -lpam -lmimalloc -lluajit-5.1 -lstdc++fs
