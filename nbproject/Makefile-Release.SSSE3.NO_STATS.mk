...
# CC Compiler Flags
CCFLAGS=-pipe -std=c++17 -pthread -O2 -march=nocona -mtune=generic -mfpmath=sse -mssse3 -fstack-protector-strong -ftree-vectorize -funroll-loops
CXXFLAGS=-pipe -std=c++17 -pthread -O2 -march=nocona -mtune=generic -mfpmath=sse -mssse3 -fstack-protector-strong -ftree-vectorize -funroll-loops
