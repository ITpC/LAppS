...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lapps.sse2.nostats.notls: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/lapps.sse2.nostats.notls ${OBJECTFILES} ${LDLIBSOPTIONS} -pthread -flto -lwolfssl -lpam -lmimalloc -lluajit-5.1 -lstdc++fs
