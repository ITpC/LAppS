...
# CC Compiler Flags
CCFLAGS=-pipe -std=c++17 -pthread -O2 -march=sandybridge -mtune=generic -mfpmath=sse -msse2avx -mavx -fstack-check -fstack-protector-strong -ftree-vectorize -funroll-loops
CXXFLAGS=-pipe -std=c++17 -pthread -O2 -march=sandybridge -mtune=generic -mfpmath=sse -msse2avx -mavx -fstack-check -fstack-protector-strong -ftree-vectorize -funroll-loops
